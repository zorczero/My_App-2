...
class DetailTransaksi extends StatefulWidget {
  ...
  const DetailTransaksi({super.key, required this.transactionId});
...
class _DetailTransaksiState extends State<DetailTransaksi> {
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                overflow: TextOverflow
                                    .ellipsis, // Tambahkan ini untuk menampilkan '...'
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Row(
                ...
                children: [
                  ...
                  if (!transaction
                      .isPaid) // Hanya tampilkan tombol jika belum lunas
                    ElevatedButton(
                      onPressed: () {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                _confirmMarkAsLunas(); // Lanjutkan dengan aksi menandai lunas
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.green,
              ),
  ...
  void _confirmMarkAsLunas() async {
    try {
      // Panggil fungsi markAsLunas dari database
      await database.markAsLunas(widget.transactionId);

      // Tampilkan pesan sukses
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Transaksi ditandai sebagai lunas')),
      );

      // Kembali ke Screen1
      Navigator.pop(context); // Kembali ke layar sebelumnya
    } catch (e) {
      // Tampilkan error jika ada masalah saat update
